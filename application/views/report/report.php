		...
		<div class="col-md-12">
			<div class="main_part">
				...
				<div class="change_passport_body">
					...
					<form name="reportForm" method="POST" autocomplete="off" action="<?php echo base_url('report-generate')?>" onsubmit="return validateForm()" target="_blank">
					  ...
					  <div class="footer-box">
					  	<button type="submit" id="submit" class="btn btn-info">Report</button>
					  </div>
					</form>
				</div>
				<br>
...
function validateForm() {
  var site_id = document.forms["reportForm"]["site_id"].value;
  var bank = document.forms["reportForm"]["bank"].value;
