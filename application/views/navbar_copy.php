  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li class="header" style="text-align: center;color: #F79F1F;letter-spacing: 1px;font-weight: bold;">
        ...
        <!-- MENU -->
        <li class="treeview">
          <a href="#"><i class="fas fa-graduation-cap icon_tree_color"></i> <span>MENU</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url('CREATE-MENU')?>"><i class="far fa-circle icon_tree_color"></i> CREATE MENU</a></li>

            <li><a href="<?php echo base_url('MENU-LIST')?>"><i class="far fa-circle icon_tree_color"></i> MENU LIST</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url('UPDATED-SITE-DATA')?>"><i class="far fa-circle icon_tree_color"></i> UPDATED SITE DATA</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url('REPORT-SEARCH')?>"><i class="far fa-circle icon_tree_color"></i> SITE SEARCH REPORT</a></li>

            <li><a href="<?php echo base_url('RUNNING-HOUR-REPORT')?>"><i class="far fa-circle icon_tree_color"></i> PDB/GEN RUNNING REPORT</a></li>

            <li><a href="<?php echo base_url('FUEL-TOTAL-CONSUMPTION-REPORT')?>"><i class="far fa-circle icon_tree_color"></i> FUEL CONSUMPTION REPORT</a></li>

            <li><a href="<?php echo base_url('FUEL-DETAIL-REPORT')?>"><i class="far fa-circle icon_tree_color"></i> FUEL AVERAGE REPORT</a></li>

           <!--  <li><a href="<?php echo base_url('FUEL-INDIVIDUAL-SITE-REPORT')?>"><i class="far fa-circle icon_tree_color"></i> INDIVIDUAL SITE FUEL REPORT</a></li> -->
