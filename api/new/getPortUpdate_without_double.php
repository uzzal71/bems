...
if ($results->num_rows > 0)
{
    while($row = $results->fetch_assoc())
    {
         $string_discharging_current_max = $row["max"];
         $string_discharging_current_min = $row["min"];
         $string_discharging_current_min2 = $row["min2"];
    }
}
...
/** IR Data Range **/
	...
	if ($site_type==1)
    {
		...
		$str_current_min2 = $string_current1_min2;
	}
	...
	if ($site_type==2)
    {
		...
		$str_current_min2 = $string_current2_min2;
	}
    ...
    for($i = 0; $i < $no_of_records; $i++)
	{
        ...
        {
            if((int)$volt[0] > $string_volt_max)
            {
                $sql = "INSERT INTO alarm (date_time, device_id, site_id, bank, node, parameter, value, remarks, status, active, inactive_time) VALUES (NOW(), $device_id, $site_id, $bank, '$node[$i]', 'String Volt', $volt[0], 'String Volt High', 0, 0, null)";
                $row = $conn->query($sql);
            }
            elseif((int)$volt[0] <= $string_volt_min && $volt[0] < $string_volt_min2)
            {
              $sql = "INSERT INTO alarm (date_time, device_id, site_id, bank, node, parameter, value, remarks, status, active, inactive_time) VALUES (NOW(), $device_id, $site_id, $bank, '$node[$i]', 'String Volt', $volt[0], 'String Volt Low', 0, 0, null)";
            $row = $conn->query($sql);
            }
            elseif((int)$volt[0] < $string_volt_min2)
            {
              $sql = "INSERT INTO alarm (date_time, device_id, site_id, bank, node, parameter, value, remarks, status, active, inactive_time) VALUES (NOW(), $device_id, $site_id, $bank, '$node[$i]', 'String Volt', $volt[0], 'String Volt Over Discharge', 0, 0, null)";
            $row = $conn->query($sql);
            }
            else
            {
        ...
        if(isset($volt[$j]) AND ($volt[$j] != "Disconnected"))
        {
            ...
            {
                $sql = "INSERT INTO alarm (date_time, device_id, site_id, bank, node, parameter, value, remarks, status, active, inactive_time) VALUES (NOW(), $device_id, $site_id, $bank, '$node[$i]', 'Cell Volt', $volt[$j], 'Cell Volt High', 0, 0, null)";
                $row = $conn->query($sql);
            }
            elseif((int)$volt[$j] <= $cell_volt_min && (int)$volt[$j] < $cell_volt_min2)
            {
               $sql = "INSERT INTO alarm (date_time, device_id, site_id, bank, node, parameter, value, remarks, status, active, inactive_time) VALUES (NOW(), $device_id, $site_id, $bank, '$node[$i]', 'Cell Volt', $volt[$j], 'Cell Volt Low', 0, 0, null)";
                $row = $conn->query($sql);
            }
            elseif((int)$volt[$j] < $cell_volt_min2)
            {
               $sql = "INSERT INTO alarm (date_time, device_id, site_id, bank, node, parameter, value, remarks, status, active, inactive_time) VALUES (NOW(), $device_id, $site_id, $bank, '$node[$i]', 'Cell Volt', $volt[$j], 'Cell Volt Critically Low', 0, 0, null)";
                $row = $conn->query($sql);
            }
            else
            {
        ...
        {
            if((int)$temp[0] > $string_temp_max)
            {
                $sql = "INSERT INTO alarm (date_time, device_id, site_id, bank, node, parameter, value, remarks, status, active, inactive_time) VALUES (NOW(), $device_id, $site_id, $bank, '$node[$i]', 'String Temperature', $temp[0], 'String Temperature High', 0, 0, null)";
                $row = $conn->query($sql);
            }
            elseif((int)$temp[0] <= $string_temp_min && $temp[0] < $string_temp_min2)
            {
              $sql = "INSERT INTO alarm (date_time, device_id, site_id, bank, node, parameter, value, remarks, status, active, inactive_time) VALUES (NOW(), $device_id, $site_id, $bank, '$node[$i]', 'String Temperature', $temp[0], 'String Temperature Low', 0, 0, null)";
                $row = $conn->query($sql);
            }
            elseif((int)$temp[0] < $string_temp_min2)
            {
              $sql = "INSERT INTO alarm (date_time, device_id, site_id, bank, node, parameter, value, remarks, status, active, inactive_time) VALUES (NOW(), $device_id, $site_id, $bank, '$node[$i]', 'String Temperature', $temp[0], 'String Temperature Critically Low', 0, 0, null)";
                $row = $conn->query($sql);
            }
            else
            {
        ...
        {
            if((int)$temp[$j] > $cell_temp_max)
            {
                $sql = "INSERT INTO alarm (date_time, device_id, site_id, bank, node, parameter, value, remarks, status, active, inactive_time) VALUES (NOW(), $device_id, $site_id, $bank, '$node[$i]', 'Cell Temperature', $temp[$j], 'Cell Temperature High', 0, 0, null)";
                $row = $conn->query($sql);
            }
            elseif((int)$temp[$j] <= $cell_temp_min && (int)$temp[$j] < $cell_temp_min2)
            {
                $sql = "INSERT INTO alarm (date_time, device_id, site_id, bank, node, parameter, value, remarks, status, active, inactive_time) VALUES (NOW(), $device_id, $site_id, $bank, '$node[$i]', 'Cell Temperature', $temp[$j], 'Cell Temperature Low', 0, 0, null)";
                $row = $conn->query($sql);
            }
            elseif ((int)$temp[$j] < $cell_temp_min2)
            {
                $sql = "INSERT INTO alarm (date_time, device_id, site_id, bank, node, parameter, value, remarks, status, active, inactive_time) VALUES (NOW(), $device_id, $site_id, $bank, '$node[$i]', 'Cell Temperature', $temp[$j], 'Cell Temperature Critically Low', 0, 0, null)";
                $row = $conn->query($sql);
            }
            else
            {
        ...
        {
            //echo $amp[$j];echo "P";
            if((int)$amp[0] > $str_current_max)
            {
                $sql = "INSERT INTO alarm (date_time, device_id, site_id, bank, node, parameter, value, remarks, status, active, inactive_time) VALUES (NOW(), $device_id, $site_id, $bank, '$node[$i]', 'String Current', $amp[0], 'String Charging Current High', 0, 0, null)";
                $row = $conn->query($sql);
            }
            elseif((int)$amp[0] < $str_current_min && (int)$amp[0] < $str_current_min2)
            {
                $sql = "INSERT INTO alarm (date_time, device_id, site_id, bank, node, parameter, value, remarks, status, active, inactive_time) VALUES (NOW(), $device_id, $site_id, $bank, '$node[$i]', 'String Current', $amp[0], 'String Charging Current Low', 0, 0, null)";
                $row = $conn->query($sql);
            }
            elseif((int)$amp[0] < $str_current_min2)
            {
                $sql = "INSERT INTO alarm (date_time, device_id, site_id, bank, node, parameter, value, remarks, status, active, inactive_time) VALUES (NOW(), $device_id, $site_id, $bank, '$node[$i]', 'String Current', $amp[0], 'String Charging Current Critically Low', 0, 0, null)";
                $row = $conn->query($sql);
            }
            else
            {
        ...
        if(isset($amp[0]) AND ($amp[0] != "Disconnected"))
        {
            if((int)$amp[0] < 0)
            {
                if((int)$amp[0] < $string_discharging_current_max)
                {
                    $sql = "INSERT INTO alarm (date_time, device_id, site_id, bank, node, parameter, value, remarks, status, active, inactive_time) VALUES (NOW(), $device_id, $site_id, $bank, '$node[$i]', 'String Current', $amp[0], 'String Discharging Current High', 0, 0, null)";
                    $row = $conn->query($sql);
                }
                elseif((int)$amp[0] >= $string_discharging_current_min && (int)$amp[0] < $string_discharging_current_min2)
                {
                    $sql = "INSERT INTO alarm (date_time, device_id, site_id, bank, node, parameter, value, remarks, status, active, inactive_time) VALUES (NOW(), $device_id, $site_id, $bank, '$node[$i]', 'String Current', $amp[0], 'String Discharging Current Low', 0, 0, null)";
                    $row = $conn->query($sql);
                }
                elseif((int)$amp[0] > $string_discharging_current_min2)
                {
                    $sql = "INSERT INTO alarm (date_time, device_id, site_id, bank, node, parameter, value, remarks, status, active, inactive_time) VALUES (NOW(), $device_id, $site_id, $bank, '$node[$i]', 'String Current', $amp[0], 'String Discharging Current Critically Low', 0, 0, null)";
                    $row = $conn->query($sql);
                }
                else
                {
        ...
        {
            if((float)$ir[$j] > $ir_max)
            {
                $sql = "INSERT INTO alarm (date_time, device_id, site_id, bank, node, parameter, value, remarks, status, active, inactive_time) VALUES (NOW(), $device_id, $site_id, $bank, '$node[$i]', 'IR', $ir[$j], 'IR Over Limit', 0, 0, null)";
                $row = $conn->query($sql);
            }
            elseif((float)$ir[$j] <= $ir_min && (float)$ir[$j] > $ir_min2)
            {
                $sql = "INSERT INTO alarm (date_time, device_id, site_id, bank, node, parameter, value, remarks, status, active, inactive_time) VALUES (NOW(), $device_id, $site_id, $bank, '$node[$i]', 'IR', $ir[$j], 'IR Low', 0, 0, null)";
                $row = $conn->query($sql);
            }
            elseif((float)$ir[$j] < $ir_min2)
            {
                $sql = "INSERT INTO alarm (date_time, device_id, site_id, bank, node, parameter, value, remarks, status, active, inactive_time) VALUES (NOW(), $device_id, $site_id, $bank, '$node[$i]', 'IR', $ir[$j], 'IR Critically', 0, 0, null)";
                $row = $conn->query($sql);
            }
            else
            {
                $sql = "UPDATE `alarm` SET active = 1, inactive_time = NOW() WHERE device_id = '$device_id' AND site_id = '$site_id' AND bank = $bank AND node = '$node[$i]' AND  parameter = 'IR' ";
                $row = $conn->query($sql);
            }
        }	
    }
